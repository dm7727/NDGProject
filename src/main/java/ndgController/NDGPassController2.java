...
public class NDGPassController2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		*/
		...
		req.getRequestDispatcher("/02Normal/pass2.jsp").forward(req, resp);
	}
			...
			*/
			if(mode.equals("edit")) {
				...
				*/
				...
				resp.sendRedirect("./fanedit.do?idx=" + idx);
			}
			else if (mode.equals("delete")) {
				//삭제인 경우 커넥션풀을 통해 DB연결
				dao = new ndgfanboardDAO();
				//기존의 게시물을 얻어온다.
				...
				JSFunction.alertLocation(resp, "삭제되었습니다.", "./fanlist.do");
			}
		}
		else {
