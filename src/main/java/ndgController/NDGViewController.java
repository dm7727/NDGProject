...
public class NDGViewController extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//req.getRequestDispatcher("/02Normal/view.jsp").forward(req, resp);
		...
		if(commandStr.equals("/view.do")){
			...
			req.getRequestDispatcher("/01Admin/freeboardview.jsp").forward(req, resp);
		}
	}
}
