...
public class NDGEditController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		*/
		...
		req.getRequestDispatcher("/02Normal/edit.jsp").forward(req, resp);
...
//		}
//		else {
//			req.getRequestDispatcher("/01Admin/freeboardedit.jsp").forward(req, resp);
//		}
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		*/
		...
		if(result==1) {
			...
			JSFunction.alertLocation(resp, "비밀번호검증을 다시 진행해주세요", "./view.do?idx="+idx );
		}
...
//				//수정이 완료되었다면 session에 저장된 패스워드를 지운후 상세보기 화면으로 이동한다.
//				session.removeAttribute("pass");
//				resp.sendRedirect("./adminview.do?idx=" + idx);
//			}
//			else {
//				JSFunction.alertLocation(resp, "비밀번호검증을 다시 진행해주세요", "./adminview.do?idx="+idx );
//			}
//			//req.getRequestDispatcher("/01Admin/freeboardedit.jsp").forward(req, resp);
//		}
	}
