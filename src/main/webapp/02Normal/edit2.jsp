...
<body>
	...
	<nav class="navbar navbar-expand-sm" style="background-color: #FFFED9">
	  	<div class="container-fluid justify-content-center">
		    <ul class="navbar-nav">
		      	...
		      	<li class="nav-item">
		        	<a class="nav-link active" href="./fanlist.do" 
	...
	<div class="container-fluid" style="background-color: rgb(252, 252, 249);">
		<form name="writeFrm" method="post" enctype="multipart/form-data" 
			action="./fanedit.do" onsubmit="return validateForm(this);">
			
		<!-- 게시물 수정을 위해 일련번호와 기존 파일명을 hidden박스에 추가한다. -->
		<input type="hidden" name="idx" value="${dto.idx }" />
		<!-- 기존의 원본파일명 -->
		<input type="hidden" name="prevOfile" value="${dto.ofile1 }" />
		<!-- 기존의 서버에 저장된 파일명 -->
		<input type="hidden" name="prevSfile" value="${dto.sfile1 }" />
		...
		<table border="1" width="90%">
			...
			<tr>
				<td>첨부파일</td>
				<td>
					<c:if test="${not empty dto.sfile1 }">
						${dto.ofile1 }
