...
<body>
	...
	<div class="container-fluid" style="background-color: rgb(252, 252, 249);">
		<div class="container mt-3">
		  	<br>
		  	<h2 style="font-family:한컴 백제 B; ">&lt;팬아트/자랑 게시판&gt;</h2>
		  	<br />
		  	<button type="button" class="btn btn-outline-primary"><a href="./list.do" class ="text-decoration-none" style="font-family:한컴 백제 B; ">자유게시판</a></button>
		  	<button type="button" class="btn btn-outline-primary"><a href="#" class ="text-decoration-none" style="font-family:한컴 백제 B;">팬아트/ 자랑게시판</a></button>
			<!-- <button><a href="./list.do" class ="text-decoration-none">자유게시판</a></button>
		  	<button><a href="#" class ="text-decoration-none">팬아트/ 자랑게시판</a></button> -->
  		<!-- 팬아트/자랑게시판 -->
  			<form method="get">  
		    ...
		    <!-- 목록 테이블 -->
		    <!-- <table class="table table-bordered" border="1" width="90%" style="text-align: center; font-family:한컴 백제 M; margin-top: 0px"> -->
		        <tr>
		            <th width="10%">번호</th>
		            <th width="*">제목</th>
		            <th width="15%">작성자</th>
			...
			<c:choose>
				...
				<c:otherwise>
					...
					<tr align="center">
						...
						<c:if test="${not empty row.ofile1 }">
							<a href="./fandownload.do?ofile1=${row.ofile1 }&sfile1=${row.sfile1}&idx=${row.idx}">[Down]</a>
						</c:if>
						</td>
					</tr>
					</c:forEach>
			...
			<!-- </table>
		   하단 메뉴(바로가기, 글쓰기)
		    <table class="table table-bordered" border="1" width="90%" style="font-family:한컴 백제 M; "> -->
		        <tr align="center">
		            <td colspan="6">
		            	${map.pagingImg }
		            </td>
		        ...
		        <tr style="text-align: right;">
		            <td width="1000" colspan="6">
					    ...
					    %>
					    <button type="button" onclick="location.href='./fanwrite.do';">글쓰기</button>
					    <%}%>
		            </td>
		        </tr>
		    </table>
