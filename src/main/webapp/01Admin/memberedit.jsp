    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
                <div class="container">
					<form name="writeFrm" method="post" action="./memberedit.do" >
					<table class="table table-bordered" border="1" width="90%">
					    ...
					    <tr>
					        ...
					        <td><input type="hidden" name="userid" style="width:90%" value="${dto.userid }" /></td>
					    </tr>
					    <tr>
					    	<td>비밀번호</td>
					    	<td><input type="text" name="pass" style="width:90%" value="${dto.pass }" /></td>
					    </tr>
					    <tr>
					    	<td>이름</td>
					    	<td><input type="text" name="name" style="width:90%" value="${dto.name }" /></td>
					    </tr>
					    <tr>
					        <td>성별</td> 
					        <td><input type="text" name="gender" style="width:90%" value="${dto.gender }" /></td>
					    </tr>
					    <tr>
					        <td>주소</td> 
					        <td><input type="text" name="address" style="width:90%" value="${dto.address }" /></td>
					    </tr>
					    <tr>
					    	<td>이메일</td> 
					    	<td><input type="text" name="email" style="width:90%" value="${dto.email }" /></td>
					    </tr>
					    <tr>
					        <td>휴대폰</td> 
					        <td><input type="text" name="mobile" style="width:90%" value="${dto.mobile }" /></td>
					    </tr>
